...
describe SourcedStore::ConsumerGroups do
  ...
  describe "#checkin" do
    ...
    it "loads group state from snapshot event" do
      json = %({"group":{"seq":10,"name":"g1","consumers":{"c1":{"id":"c1","registered_at":"2022-10-26T19:27:59Z","group_name":"g1","position":0,"group_size":1,"run_at":"2022-10-26T20:47:52Z","last_seq":343}},"liveness_span":{"seconds":5,"nanoseconds":0}}})
    ...
    it "snapshots groups every X events" do
      ...
      stream[6].should be_a(SourcedStore::ConsumerGroups::Events::GroupSnapshot)
    end
